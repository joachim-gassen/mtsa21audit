...
```{r ClientMSRelative, echo = FALSE, fig.align="center", fig.cap="\\label{fig::ClientMSRelative}Realtive Client Market Share Over Time"}
...
```{r FeeMSRelative, echo = FALSE, fig.align="center", fig.cap="\\label{fig::FeeMSRelative}Realtive Fee Market Share Over Time"}
